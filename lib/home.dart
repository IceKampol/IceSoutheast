...
import 'package:kampolsbc/register.dart';
...
class _HomeState extends State<Home> {
  ...
  TextButton buildTextButton() {
    return TextButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context)=> Register(),)), 
 ...
 Container buildTextFieldPassword() => Container(
  ...
  Text buildText() => Text(
    'Ice Southeast',
    style: GoogleFonts.stalinistOne(textStyle: TextStyle(
      fontSize: 20,
